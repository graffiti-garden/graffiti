...
export interface GraffitiObjectBase {
   ...
   * (see the [local implementation](https://github.com/graffiti-garden/graffiti/tree/main/implementations/local))
   * and implementation-specific Graffiti URLs for objects stored on web services
   * (see the [decentralized implementation](https://github.com/graffiti-garden/graffiti/tree/main/implementations/decentralized)).
