...
<style scoped>
aside { position: fixed; inset: 0; display: grid; align-items: start; justify-items: center; overflow: auto; scrollbar-gutter: stable both-edges; padding: 1rem; background: rgb(0 0 0 / 20%); }
...
@media (max-width: 42rem) { aside { padding: 0.75rem; } dialog { width: 100%; } footer, .actions { display: grid; grid-template-columns: 1fr; } .actions { order: -1; } button, :deep(button) { width: 100%; } }
</style>
