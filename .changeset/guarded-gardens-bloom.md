---
"@graffiti-garden/wrapper-data-guard": minor
---

Store remembered permissions as private Graffiti objects so they remain available across browser storage partitions and can be reviewed in the audit panel.
